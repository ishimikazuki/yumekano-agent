...
export const TurnTraceSchema = z.object({
  ...
  modelIds: z.object({
    ...
    coeExtractor: z.string().optional(),
  ...
  modelAliases: z.object({
    ...
    ranker: z.string(),
    extractor: z.string(),
    coeExtractor: z.string(),
    consolidation: z.string().optional(),
  }).optional().describe('Model role aliases used for each stage'),
  stageLatencies: z.object({
    coeExtractorMs: z.number(),
    plannerMs: z.number(),
    generatorMs: z.number(),
    rankerMs: z.number(),
    memoryExtractorMs: z.number(),
    consolidationMs: z.number().optional(),
    totalMs: z.number(),
  }).optional().describe('Per-stage latency in milliseconds'),
